...
Per la corretta compilazione del progetto è necessario l'utilizzo di g++ (compilatore del linguaggio C++), la libreria grafica SFML e CMake. %e librerie SFML?? <------ !!!
...
{\includegraphics[width=.60\textwidth]{images/Figura_1.png}} \quad \subfloat[h][\emph{standard output da terminale}]
{\includegraphics[width=.25\textwidth]{images/Figura_2.png}} \\
\caption{}
\label{fig:subfig}
\end{figure}
...
{\includegraphics[width=.55\textwidth]{images/Figura_3.png}} \quad \subfloat[h][\emph{grafico della situazione di contagio secondo il modello attuale}]
{\includegraphics[width=.34\textwidth]{images/Figura_4.png}} \\
\caption{}
\label{fig:subfig}
\end{figure}
